 ...
 */ // BMH 2026-01-18 ln100 securepay + fatzebra logos
?>
...
<?php
    ...
    if (SHOW_ACCEPTED_CREDIT_CARDS == '2') {
      ...
      /* BMH 2020-11-28 */
      echo '<img class="securepaylogo" src="images/icons/securepay_logo_rgb.png">';
      echo '<img class="securepaylogo" src="images/icons/fatzebra_logo_rgb.png">';
      /* BMH eoc */
    }
?>
<br class="clearBoth">
...
<div class="buttonRow forward" id="paymentSubmit"><?php echo zen_image_submit(BUTTON_IMAGE_CONTINUE_CHECKOUT, BUTTON_CONTINUE_ALT, 'onclick="submitFunction('. $gv_balance .','.$order->info['total'].')"'); ?></div>
